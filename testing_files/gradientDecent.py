...
ax.set_xlabel('a', labelpad=30, fontsize=24, fontweight='bold')
ax.set_ylabel('b', labelpad=30, fontsize=24, fontweight='bold')
ax.set_zlabel('f(a, b)', labelpad=30, fontsize=24, fontweight='bold')
...
ax.plot([t[0] for t in history], [t[1] for t in history], cost )
